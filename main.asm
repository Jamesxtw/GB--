...
;main.c:5: unsigned char c01[] =
	...
	ld	hl, #(_c01 + 0x003f)
	ld	(hl), #0x44
;main.c:17: INT8 currentspriteindex = 27 ; //set tile to 27
	ld	hl, #_currentspriteindex
	ld	(hl), #0x1b
;main.c:18: INT8 floorsurfaceposition = 104 ;
	ld	hl, #_floorsurfaceposition
	ld	(hl), #0x68
;main.c:20: UINT8 p1movespeed = 0 ; //P1 speed
	ld	hl, #_p1movespeed
	ld	(hl), #0x00
;main.c:25: INT8 gravity = -2 ;
	ld	hl, #_gravity
	ld	(hl), #0xfe
;--------------------------------------------------------
; Home
...
;--------------------------------------------------------
	.area _CODE
;main.c:27: INT8 wouldthespritehitthefloor(INT8 projectfloorposition)
;	---------------------------------
; Function wouldthespritehitthefloor
; ---------------------------------
_wouldthespritehitthefloor::
;main.c:29: if (projectfloorposition >= floorsurfaceposition)
	ld	hl, #_floorsurfaceposition
	ld	e, (hl)
	ldhl	sp,	#2
	ld	a,(hl)
...
00111$:
	jr	C, 00102$
;main.c:31: return floorsurfaceposition;
	ld	hl, #_floorsurfaceposition
	ld	e, (hl)
	ret
00102$:
...
;main.c:34: }
	ret
;main.c:36: void performentdelay (UINT8 numloops)//wait frame generate delay
;	---------------------------------
...
;main.c:43: } 
	jr	00103$
;main.c:47: void BKG1() //BKGMAIN
;	---------------------------------
; Function BKG1
; ---------------------------------
_BKG1::
;main.c:49: set_bkg_data(0,16,backgroundtile);
	ld	hl, #_backgroundtile
	push	hl
	ld	a, #0x10
	push	af
	...
	call	_set_bkg_data
	add	sp, #4
;main.c:50: set_bkg_tiles(0,0,MAP1Width,MAP1Height,MAP1);
	ld	hl, #_MAP1
	push	hl
	ld	de, #0x1220
	push	de
...
;main.c:52: }
	ret
;main.c:54: void BKGSCOLLRIGHT() //BKG RIGHT
;	---------------------------------
; Function BKGSCOLLRIGHT
; ---------------------------------
_BKGSCOLLRIGHT::
;main.c:56: scroll_bkg(p1movespeed,0);
	ld	hl, #_p1movespeed
	ld	c, (hl)
...
;main.c:57: }
	ret
;main.c:59: void BKGSCOLLLEFT() //BKG LEFT
;	---------------------------------
; Function BKGSCOLLLEFT
; ---------------------------------
_BKGSCOLLLEFT::
;main.c:61: scroll_bkg(-p1movespeed,0);
	xor	a, a
	ld	hl, #_p1movespeed
	sub	a, (hl)
	ld	c, a
...
;main.c:62: }
	ret
;main.c:66: void player1( )//P1main
;	---------------------------------
; Function player1
; ---------------------------------
_player1::
;main.c:68: set_sprite_data ( 27, 4, c01);
	ld	hl, #_c01
	push	hl
	ld	de, #0x041b
	push	de
...
;c:/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	...
	ld	(hl), #0x1b
;main.c:70: playerlocation[0]= 20;  //x axis
	ld	hl, #_playerlocation
	ld	a, #0x14
	ld	(hl+), a
	ld	(hl), #0x00
;main.c:71: playerlocation[1]= 104; //y axis
	ld	hl, #(_playerlocation + 0x0002)
	ld	a, #0x68
	ld	(hl+), a
	ld	(hl), #0x00
;main.c:72: move_sprite( 0,playerlocation[0],floorsurfaceposition);
	ld	hl, #_floorsurfaceposition
	ld	c, (hl)
	ld	hl, #_playerlocation
	ld	b, (hl)
...
;main.c:77: }
	ret
;main.c:79: void jump () //P1jump
;	---------------------------------
; Function jump
; ---------------------------------
_jump::
	add	sp, #-2
;main.c:83: if (jumpornot==0)
	ld	hl, #_jumpornot
	ld	a, (hl)
	or	a, a
	jr	NZ, 00102$
;main.c:85: jumpornot = 1;
	ld	(hl), #0x01
;main.c:86: speedY = -10 ;
	ld	hl, #_speedY
	ld	(hl), #0xf6
00102$:
;main.c:89: speedY = speedY - gravity ;
	ld	a, (#_speedY)
	ld	hl, #_gravity
	sub	a, (hl)
	ld	(#_speedY),a
;main.c:90: playerlocation [1] = playerlocation [1]+speedY ;
...
;c
	...
	ld	(hl+), a
	ld	(hl), c
;main.c:92: possiblefloorpositionY=wouldthespritehitthefloor(playerlocation [1]);
	push	bc
	inc	sp
	...
	ldhl	sp,	#1
	ld	(hl), e
;main.c:94: if(possiblefloorpositionY > -1 )
	ld	e, (hl)
	ld	a,#0xff
	ld	d,a
	sub	a, (hl)
...
00121$:
	jr	NC, 00104$
;main.c:96: jumpornot = 0;
	ld	hl, #_jumpornot
	ld	(hl), #0x00
;main.c:97: move_sprite( 0,playerlocation[0],possiblefloorpositionY);
	ld	hl, #_playerlocation
	ld	c, (hl)
;c:/gbdk/include/gb/gb.h:1218: OAM_item_t * itm = &shadow_OAM[nb];
	ld	de, #_shadow_OAM+0
...
;main.c:97: move_sprite( 0,playerlocation[0],possiblefloorpositionY);
	jr	00108$
00104$:
;main.c:101: move_sprite( 0,playerlocation[0], playerlocation[1]); 
...
;main.c:103: } 
	add	sp, #2
	ret
;main.c:105: void playermoveright() //MOVEright
;	---------------------------------
; Function playermoveright
; ---------------------------------
_playermoveright::
;main.c:107: if (currentspriteindex == 28)
	ld	a, (#_currentspriteindex)
	sub	a, #0x1c
	jr	NZ, 00102$
;main.c:109: currentspriteindex = 27 ;
	ld	hl, #_currentspriteindex
	ld	(hl), #0x1b
00102$:
;main.c:112: set_sprite_tile ( 0,currentspriteindex);
	ld	hl, #_currentspriteindex
	ld	c, (hl)
;c:/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 0x0002)
	ld	(hl), c
;main.c:114: playerlocation[0]=playerlocation[0]+p1movespeed;
	ld	hl, #_playerlocation
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
	...
	ld	a, c
	ld	(hl+), a
;main.c:115: move_sprite(0,playerlocation[0],playerlocation[1]);
	ld	a, b
	ld	(hl+), a
	ld	e, (hl)
;c:/gbdk/include/gb/gb.h:1218: OAM_item_t * itm = &shadow_OAM[nb];
...
;main.c:117: }
	ret
;main.c:119: void playermoveleft() //MOVEleft
;	---------------------------------
; Function playermoveleft
; ---------------------------------
_playermoveleft::
;main.c:122: if (currentspriteindex == 27 )
	ld	a, (#_currentspriteindex)
	sub	a, #0x1b
	jr	NZ, 00102$
;main.c:124: currentspriteindex = 28 ;
	ld	hl, #_currentspriteindex
	ld	(hl), #0x1c
00102$:
;main.c:127: set_sprite_tile ( 0,currentspriteindex);
	ld	hl, #_currentspriteindex
	ld	c, (hl)
;c:/gbdk/include/gb/gb.h:1145: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 0x0002)
	ld	(hl), c
;main.c:128: playerlocation[0]=playerlocation[0]-p1movespeed ;
	ld	hl, #_playerlocation
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
...
;main.c:131: }
	ret
;main.c:133: void player1con() //P1con
;	---------------------------------
; Function player1con
; ---------------------------------
_player1con::
;main.c:135: if (joypad() & J_RIGHT ) //right bottom
	call	_joypad
	ld	a, e
	rrca
	jr	NC, 00102$
;main.c:137: playermoveright();
	call	_playermoveright
;main.c:138: BKGSCOLLRIGHT();
	call	_BKGSCOLLRIGHT
00102$:
;main.c:141: if (joypad() & J_LEFT ) //left bottom
	call	_joypad
	bit	1, e
	jr	Z, 00104$
;main.c:143: playermoveleft();
	call	_playermoveleft
;main.c:144: BKGSCOLLLEFT();
	call	_BKGSCOLLLEFT
00104$:
;main.c:147: if (joypad() & J_A || jumpornot == 1 ) //A bottom
	call	_joypad
	bit	4, e
	jr	NZ, 00105$
	ld	a, (#_jumpornot)
